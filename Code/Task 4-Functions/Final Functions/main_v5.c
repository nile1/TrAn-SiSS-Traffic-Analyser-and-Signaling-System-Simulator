...
street_t *add_street_to_map_extn_node(graph_tsj_t *g,int men_id, char *st_name ,int tsj1_id , int type);
...
street_t *add_street_to_map_extn_node(struct graph_tsj *g,int tsj1_id,int men_id , char *st_name , int type)
{
	int index,i;
...
map_extn_t *create_map_extn(graph_tsj_t *g,char *name, int time_of_generation , traffic_sig_jn_t *adj_tsj)
{
    ...
    newnode->connecting_street = add_street_to_map_extn_node(g,get_men_id(newnode),name,get_tsj_id(adj_tsj),2);
