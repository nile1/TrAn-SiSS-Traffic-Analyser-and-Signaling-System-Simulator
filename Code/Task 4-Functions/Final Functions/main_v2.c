...
int graph_add_street(graph_tsj_t *g,int tsj1_id,int tsj2_id , char *st_name , int type);
...
int graph_delete_tsj(graph_tsj_t *g,traffic_sig_jn_t *t)
{
	...
	else
	{
		...
		for(int i=get_tsj_id(t)-1;i<MAX_TSJ;i++)
		{
...
map_extn_t *create_map_extn(graph_tsj_t *g,char *name, int time_of_generation , traffic_sig_jn_t *adj_tsj)
{
    ...
    newnode->connecting_street = add_street_to_map_extn_node(g,get_men_id(newnode),name,adj_tsj,2);
                                ...
                                */
                                switch(c_map_extn_node)
                                {
                                    ...
                                    case 2:
                                        ...
                                        delete_map_extn(men_list, gen_num(id));
                                        break;
                                    case 3:
                                        break;
