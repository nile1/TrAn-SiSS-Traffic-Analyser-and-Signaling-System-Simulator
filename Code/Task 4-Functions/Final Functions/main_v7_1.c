...
void queue_delete(lane_t *l);                                                                                              // add graphics function.
char *gen_num(int n);
...
float set_traffic_status(street_t *s, traffic_sig_jn_t *t)
{
	...
	l = (lane_t ***)malloc(sizeof(lane_t **)*2);
	l[0] = (lane_t **)malloc(sizeof(lane_t *)*2);
	l[1] = (lane_t **)malloc(sizeof(lane_t *)*2);
...
{
    int i,j, k[2], index, l[2], la[2], num_tsj;
    int num_street;
    num_tsj = g->num_tsj;
    street_t *street[4];
...
int main()
{
    ...
    traffic_sig_jn_t *new_tsj,*temp_tsj,*adj_tsj;
    //street_t *st;
    coordinate_t c;
    style_t s;
                                ...
                                */
                                switch(c_street)
                                {
                                    ...
                                    /* Add Street */
                                        ...
                                        graph_add_street(&g1,id_1,id_2,name,"four_way");
                                        break;
